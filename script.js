function showSummary() {
    ...
    const creditLimit = parseFloat(document.querySelector('input[name="creditLimit"]').value);
    const loanTerm = parseFloat(document.querySelector('input[name="loanTerm"]').value);
    ...
    const monthlyPayment = calculateMonthlyPayment(creditLimit, loanTerm, interestRate);
